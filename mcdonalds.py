...
for day in sales_data:
    sales_date = day["Hamburgare"] * 50 
    sales_date += day["Pommes frites"] * 25 
    sales_date += day["Läsk"] * 20 
    sales_date += day["Milkshake"] * 30
    sales_date += day["Sallader"] * 45 
    sales_date += day["McNuggets"] * 35 
    print(sales_date)
